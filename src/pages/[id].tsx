...
const RelatedAnime = dynamic<RelatedAnimeProps>(() => import('../components/animePage/RelatedAnime'))
          ...
          <Box w="885px" as="article">
            ...
            {AnimePage.related &&
              (AnimePage.related['Alternative version'] ||
                ...
                AnimePage.related.Other) && <RelatedAnime related={AnimePage.related} />}
          </Box>
...
export const getStaticProps: GetStaticProps = async (context: GetStaticPropsContext) => {
  ...
  if (params !== undefined) {
    if (typeof params.id === 'string') {
      ...
      const ANIME_DATA: AnimePageProps = await api.get(`/anime/id/${mal_id}`).then((res) => res.data)
      return {
        props: {
          ANIME_DATA,
          mal_id,
